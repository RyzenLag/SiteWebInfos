		...
		<div class="container box_1170">
			<div class="section-top-border">
				...
				<div class="row gallery-item">
					<div class="col-md-4">
						<a href="Richard-Mille-RM-11-03-McLaren-Automatic-Flyback-Chronograph-3-1-min.jpg.crdownload" class="img-pop-up img-gal">
							<div class="single-gallery-image" style="background: url(Richard-Mille-RM-11-03-McLaren-Automatic-Flyback-Chronograph-3-1-min.jpg.crdownload);"></div>
						</a>
					</div>
					<div class="col-md-4">
						<a href="rolex, Patek Philippe.jfif" class="img-pop-up img-gal">
							<div class="single-gallery-image" style="background: url(rolex\,\ Patek\ Philippe.jfif);"></div>
						</a>
					</div>
					<div class="col-md-4">
